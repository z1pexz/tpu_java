...
public class WorkJeep extends Jeep {
    private int Mileage;
    ...
    public WorkJeep(int MaxSpeed, int PeopleCapacity, String Color, String CarModel, String FuelType, int EnginePower,  int Mileage) {
