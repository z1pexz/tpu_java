...
public class WorkGasolineTanker extends GasolineTanker {
    private int VolumeTank;

    public WorkGasolineTanker() {
        super();
    }
    ...
    public WorkGasolineTanker(int MaxSpeed, int PeopleCapacity, String Color, String CarModel, int MaxLoad, int NumberOfTrailers, int VolumeTank) {
