...
public class CivilGasolineTanker extends GasolineTanker {
    private int VolumeTank;

    public CivilGasolineTanker() {
        super();
    }

    @Override
    public String getDescription() {
        return "This is civil GasolineTanker. Volume of the tank is " + this.VolumeTank + " liter. Maximum of the speed is " +
    ...
    public CivilGasolineTanker(int MaxSpeed, int PeopleCapacity, String Color, String CarModel, int MaxLoad, int NumberOfTrailers, int VolumeTank) {
