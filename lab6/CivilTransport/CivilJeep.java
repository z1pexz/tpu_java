...
public class CivilJeep extends Jeep {
private int Mileage;
...
public String getDescription() {
        return "This is civil Jeep. Mileage is " + this.Mileage + " km. Maximum of the speed is " +
...
public CivilJeep(int MaxSpeed, int PeopleCapacity, String Color, String CarModel, String FuelType, int EnginePower,  int Mileage) {
