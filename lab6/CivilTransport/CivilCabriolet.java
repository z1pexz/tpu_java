...
public class CivilCabriolet extends Cabriolet{
    private int Mileage;

    public CivilCabriolet() {
        super();
    }
    ...
    public CivilCabriolet(int MaxSpeed, int PeopleCapacity, String Color, String CarModel, String FuelType, int EnginePower,  int Mileage) {
